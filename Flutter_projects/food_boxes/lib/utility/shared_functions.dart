...
Widget orderSummary(BuildContext context, WidgetRef ref, List<FoodBox> boxes) {
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  height: context.percentHeight(2.75),
...
SnackBar messegeSnackBar(BuildContext context, String messege,
    {int? timeUp = 1000}) {
  return SnackBar(
